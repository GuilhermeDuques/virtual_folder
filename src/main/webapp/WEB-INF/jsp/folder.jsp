...
<%--                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="download" role="tab" aria-controls="v-pills-settings" aria-selected="false">Download de arquivo</a>--%>
        ...
        <div class="col-12">
            <div class="container" style="background-color: #007bff;border-radius: 10px;color: white;margin-top: 50px; padding-bottom: 25px">
                ...
                <form method="post" action="procurar" style="color: #007bff;border-radius: 10px;font-weight: bold">
                    <input type="text" name="keyword">
                    <input type="submit" style="color: #007bff; border-radius: 10px; font-weight: bold" value="Procurar">
                </form>
                <table class="table" style="color: white">
                    ...
                    <c:forEach items="${lista}" var="file">
                        <tr>
                            ...
                            <td>${file.usuario.nome}</td>
                            <td>
                                <a style="color: white" href="/excluir/${file.id}">Excluir</a>
                                &nbsp; &nbsp; &nbsp;
                                <a style="color: white" target="_blank" href="/download/${file.id}">Download</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
